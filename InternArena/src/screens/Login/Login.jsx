					...
					>
						...
						<div className="flex flex-col items-center space-y-3">
							...
							<p className="text-xs text-neutral-400 max-w-xs text-center font-medium">
								Enter the email address synced with your
								competitive Leetcode profile.
							</p>
						</div>
						...
						<div className="flex flex-col gap-3 pt-2">
							...
							<div className="relative flex py-2 items-center">
								...
								<span className="flex-shrink mx-4 text-neutral-500 text-[10px] font-bold uppercase tracking-wider">
									New to Arena?
								</span>
								<div className="flex-grow border-t border-neutral-700/30"></div>
							</div>
