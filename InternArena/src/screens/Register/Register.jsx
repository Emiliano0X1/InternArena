...
function Register() {
    ...
    return (
        <div className="min-h-screen w-full bg-[#1a1616] text-white grid grid-cols-1 lg:grid-cols-12 overflow-hidden relative">
            ...
            {/* Left Pane - Auth Form */}
            <div className="relative flex flex-col items-center justify-center p-4 md:p-8 lg:col-span-5 z-10 min-h-screen">
                ...
                <div className="absolute top-6 left-6 z-20">
                    <button 
                        onClick={() => navigate('/')}
                        className="group flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-neutral-400 hover:text-orange-500 transition-all cursor-pointer bg-[#2c2727]/60 backdrop-blur-md px-4 py-2.5 rounded-full border border-neutral-800/80 shadow-md animate-fade-in"
                    >
                ...
                {/* Main Content Area */}
                <div className="w-full max-w-md z-10 flex flex-col items-center justify-center space-y-8 py-12">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-3">
                            ...
                            <p className="text-xs text-neutral-400 max-w-xs text-center font-medium">
                                Put in an email address that hasn't been synced to an existing account.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            <motion.button 
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="w-full bg-gradient-to-r from-orange-500 to-amber-600 text-white rounded-xl py-3 text-sm font-bold hover:from-orange-600 hover:to-amber-700 transition-all shadow-md shadow-orange-500/10 cursor-pointer text-center animate-pulse-subtle"
                                onClick={() => navigate('/')}
                            >
                                CREATE AN ACCOUNT
                            </motion.button>
                            ...
                            <div className="relative flex py-2 items-center">
                                ...
                                <span className="flex-shrink mx-4 text-neutral-500 text-[10px] font-bold uppercase tracking-wider">Already registered?</span>
                                <div className="flex-grow border-t border-neutral-700/30"></div>
                            </div>
